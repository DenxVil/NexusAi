...
💬 **Get Started:**
Just send me a message and I'll respond with helpful information!

🌐 **Also available at:** https://denx.me/NexusAi
📱 **Try the web interface for a full experience**

_Ready to chat? Send me anything!_ ✨
...
**Created with love 🩶 by Denvil 🧑‍💻**
  ...
  private async handleHelp(msg: Message): Promise<void> {
    ...
    const helpMessage = `
🆘 *Nexus AI - Help Guide* 🆘
_Your AI Assistant Command Reference_

*💬 Basic Commands:*
• **Just chat** - Send any message to start a conversation
...
**https://denx.me/NexusAi**

*✨ Key Features:*
• Multi-AI backend (Perplexity, Gemini, HuggingFace)
...
**Created with love 🩶 by Denvil 🧑‍💻**
  ...
  private async handleInfo(msg: Message): Promise<void> {
    ...
    const infoMessage = `
🔮 *Nexus AI Bot Information* 🔮
_Advanced AI Assistant Platform_
...
*📞 Support:*
Use /help for commands or visit our website.
